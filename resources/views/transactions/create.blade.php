...
<div class="row justify-content-center shadow rounded">
	<div class="col-md-4 col-sm-12 border rounded p-3">
		<div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="account_num" id="account_num" required minlength="12"
					maxlength="12">
			</div>
			<div class="form-group">
	...
	<div class="col-md-8 col-sm-12 border rounded p-3">
		<div class="d-none" id="actions-buttons">
			<form id="transaction" method="POST" action="{{route('transactions.store')}}" enctype="multipart/form-data"
